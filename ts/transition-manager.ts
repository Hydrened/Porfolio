class TransitionManager {
    ...
    initTransitionElement() {
        this.element = document.querySelector(".transition-effect") as HTMLElement;
    }
    ...
    initMoves() {
        [...document.querySelectorAll("[move-direction][move-delay][move-duration]")].forEach((element) => {
            ...
            const direction: string = moveDirection;
            const delay: number = parseInt(moveDelay);
            const duration: number = parseInt(moveDuration);
